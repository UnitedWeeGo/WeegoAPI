...
//	private $allFields = array();
	...
	function CheckinGo()
	{
		...
		$hasCheckedIn = in_array($me->participantId, $checkedInParticipantList) || in_array($me->email, $checkedInParticipantList);
		if (!$hasCheckedIn)	
		{
			array_push($checkedInParticipantList, $me->email);
